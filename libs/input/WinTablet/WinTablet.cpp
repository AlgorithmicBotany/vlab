...
bool WinTabletImpl::init(HWND handleWnd, bool useSysFlag, bool poll)
{
    ...
    lc.lcOutExtY = -GetSystemMetrics(SM_CYVIRTUALSCREEN); // move origin to upper left
...
bool WinTabletImpl::hasOrientation()
{
    return ori;
}

bool WinTabletImpl::hasPressure()
{
    return pressure;
}
...
extern "C"
{
    __declspec(dllexport) void* getWinTabletImpl()
    {
        return new WinTabletImpl();
    }
}
